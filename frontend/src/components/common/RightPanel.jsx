                    ...
                    {!isLoading && USERS_FOR_RIGHT_PANEL?.map((user) => (
                        <Link to={`/profile/${user.username}`} className="flex items-center justify-between gap-4" key={user._id}>
                            ...
                            <div className="flex gap-2 items-center">
                                <div className="avatar">
                                    <div className="w-8 rounded-full">
                                        <img src={user.profileImg || '/avatar-placeholder.png'}></img>
                                    </div>
                                </div>
                                <div className="flex flex-col">
                                    <span className="font-semibold trackin-tight truncate w-28">
                                        {user.fullName}
                                    </span>
                            ...
                            <div>
                                ...
                                <button className="btn bg-white text-black hover:bg-white hover:opacity-90 rounded-full tbn-sm"
